...
<head>
    ...
    <title>Ubah Pemilik Resto</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Pemilik Resto</h1><br>
                    ...
                    <body>   
                        <div class="container">
                            <form action="{{ route('pemilik.update', $pemilik->id) }}" method="POST">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="resto" name="resto" placeholder="Warung Soto"  required>
                                            @error('resto')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <a href="{{ route('pemilik') }}" class="btn btn-secondary">Cancel</a>
                            </form>
                        </div>    
                    </body>
                </div>
